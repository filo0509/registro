...
class ViewHelpers {
  ...
  assetPath(asset, assetsConfig) {
    if (this.options.assetsCDN) {
      var _assetsConfig$coreScr, _assetsConfig$coreScr2;

      const pathname = (_assetsConfig$coreScr = assetsConfig === null || assetsConfig === void 0 ? void 0 : (_assetsConfig$coreScr2 = assetsConfig.coreScripts) === null || _assetsConfig$coreScr2 === void 0 ? void 0 : _assetsConfig$coreScr2[asset]) !== null && _assetsConfig$coreScr !== void 0 ? _assetsConfig$coreScr : asset;
