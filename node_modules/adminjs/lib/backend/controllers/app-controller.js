...
class AppController {
  ...
  async bulkAction({
    ...
    var _params$recordIds;

    const {
      resourceId,
      actionName
    } = params;
    const recordIds = (_params$recordIds = params.recordIds) !== null && _params$recordIds !== void 0 ? _params$recordIds : query === null || query === void 0 ? void 0 : query.recordIds;
