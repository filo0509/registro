 ...
 */
exports.name = "AdminBroExpressjs";
module.exports = { name: exports.name, buildAuthenticatedRouter: buildAuthenticatedRouter_1.buildAuthenticatedRouter, buildRouter: buildRouter_1.buildRouter };
exports.default = { name: exports.name, buildAuthenticatedRouter: buildAuthenticatedRouter_1.buildAuthenticatedRouter, buildRouter: buildRouter_1.buildRouter };
